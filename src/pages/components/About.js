    ...
    <section id="about" className="mt-[18rem] relative">
      ...
      <div className="md:mt-20 mt-10 md:grid grid-flow-col grid-cols-3">
        <div className="md:col-span-2">
          ...
          Welcome to Kunal, where we transform the web with innovative solutions for a continuously evolving world. As game-changers and digital revolutionaries, we live and breathe website creation, maintenance, and upgrades. With a dynamic team of tech enthusiasts, design wizards, and problem solvers, we turn your web dreams into reality. From tailored solutions across industries to staying at the forefront of cutting-edge technologies, we're your trusted partner on the path to online success. Let's embark on an exciting journey together and rewrite the rules of web success at Kunal, where innovation meets excellence.
          </p>
